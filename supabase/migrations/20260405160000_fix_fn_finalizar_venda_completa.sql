-- =============================================================================
-- CORREÇÃO CRÍTICA: Restaurar fn_finalizar_venda_atomica completa
-- A versão de 20260402220000 perdeu a geração de parcelas e movimentos de estoque.
-- Esta migração restaura TODAS as funcionalidades com suporte a credito_casa.
-- =============================================================================
...
BEGIN
  ...
  VALUES (
    ...
    _computed_total_cost, _computed_total_profit
  )
      ...
      THEN
        ...
        LOOP
          INSERT INTO public.movimentos_estoque (
            empresa_id, produto_id, vendedor_id, tipo, quantidade, observacoes, kit_id
          )
          VALUES (
            _empresa_id,
            (_ki->>'produto_id')::uuid,
