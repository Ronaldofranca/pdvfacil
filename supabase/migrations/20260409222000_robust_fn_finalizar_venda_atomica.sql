-- =============================================================================
-- Migration: Melhorar Robustez da fn_finalizar_venda_atomica
-- Evita falhas de cast de UUID e garante tratamento adequado de nulos.
-- =============================================================================
...
BEGIN
  ...
  LOOP
    ...
    -- Se não conseguimos determinar um produto_id válido, não inserimos o item (ou lançamos erro)
